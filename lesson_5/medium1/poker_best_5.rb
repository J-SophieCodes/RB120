...
# ])
# hand4.print
# puts hand4.evaluate #== 'Straight'
# puts

# puts "Better hand is #{[hand1, hand2, hand4].max.evaluate}"
# puts
...
# Have to do this outside of the PokerHand class
best_5 = cards.combination(5).map do |hand|
  PokerHand.new(hand)
end.max
...
puts cards
puts
puts "Best 5 is #{best_5.evaluate}" #== 'Straight flush'
best_5.print
puts
